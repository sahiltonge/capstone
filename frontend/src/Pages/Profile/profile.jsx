...
const Profile = ({ sideNavbar }) => {
  ...
  const fetchProfileData = async () => {
    try {
      const response = await axios.get(`https://youtube-clone-one-snowy.vercel.app/video/${id}/channel`);
  ...
  const handleDelete = async (videoId) => {
    ...
    try {
      await axios.delete(`https://youtube-clone-one-snowy.vercel.app/video/delete/${videoId}`, { withCredentials: true });
